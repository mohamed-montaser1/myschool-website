...
function Footer() {
  return (
    <footer className="">
      <div className="container flex items-center py-5 bg-[var(--logo-color)] flex-col px-1">
        ...
        <p className="text-white text-center">{translate["vision"]}</p>
        <div className="flex gap-5 my-3 max-[338px]:flex-col">
          <a
        ...
        <h3 className="text-white font-bold mt-3 text-center">
          {translate["copy-right"]}
        </h3>
      </div>
    </footer>
  );
